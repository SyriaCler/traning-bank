...
import { ModalNotCadastroComponent } from 'src/app/modal-not-cadastro/modal-not-cadastro.component'
...
export class LoginComponent implements OnInit {
  ...
  //função para validação de cada caracter digitado para acesso da conta
  onlynumber(evt) {
